...
func (s *VerifyRangeStateTestSuite) TestSuccess() {
	...
	s.historyQ.On("RebuildTradeAggregationBuckets", s.ctx, uint32(100), uint32(200), 0.0).Return(nil).Once()
...
func (s *VerifyRangeStateTestSuite) TestSuccessWithVerify() {
	...
	s.historyQ.On("RebuildTradeAggregationBuckets", s.ctx, uint32(100), uint32(110), 0.0).Return(nil).Once()

...
var _ decoderFrom = (*GeneralPreconditions)(nil)

// DecodeFrom decodes this value using the Decoder.
func (s *GeneralPreconditions) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	var b bool
	b, nTmp, err = d.DecodeBool()
...
func (u Preconditions) EncodeTo(e *xdr.Encoder) error {
	...
	case PreconditionTypePrecondTime:
		...
		return nil
	case PreconditionTypePrecondGeneral:
		if err = (*u.General).EncodeTo(e); err != nil {
			return err
		}
		return nil
	}
...
func (u *Preconditions) DecodeFrom(d *xdr.Decoder) (int, error) {
	...
	case PreconditionTypePrecondTime:
		...
		return n, nil
	case PreconditionTypePrecondGeneral:
		u.General = new(GeneralPreconditions)
		nTmp, err = (*u.General).DecodeFrom(d)
		n += nTmp
		if err != nil {
			return n, fmt.Errorf("decoding GeneralPreconditions: %s", err)
		}
		return n, nil
	}
...
func (s *SignerKeyEd25519SignedPayload) DecodeFrom(d *xdr.Decoder) (int, error) {
	...
	s.Payload, nTmp, err = d.DecodeOpaque(32)
	n += nTmp
	if err != nil {
